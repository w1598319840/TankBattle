...
public class GameInterfacePanel extends JPanel {
    //游戏界面的Panel
    private MyTank myTank = new MyTank(100, 100);//我的坦克
    private EnemyTank enemyTank1 = new EnemyTank(200, 100);//敌军坦克
    private EnemyTank enemyTank2 = new EnemyTank(300, 100);//敌军坦克
    private FriendlyTank friendlyTank = new FriendlyTank(400, 100);//友军坦克
    ...
    public void paint(Graphics g) {
        ...
        drawTank(g, myTank.getX(), myTank.getY(), 0, 0);
